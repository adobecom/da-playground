# build-block-from-figma — task: forge-tools-that-work-for-you
...
- **Block name:** `forge-tools-that-work-for-you`
- **Target path:** `/Users/bradjohn/Documents/da-playground/.forge-worktrees/session-8007fcd6-ms67m882/libs/c2/blocks/forge-tools-that-work-for-you` (NEVER libs/blocks/)
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-1` /
  `.forge-tools-that-work-for-you`. Use as the starting point for `forge-tools-that-work-for-you.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/bradjohn/Documents/da-playground/.forge-worktrees/session-8007fcd6-ms67m882/libs/c2/blocks/forge-tools-that-work-for-you/forge-tools-that-work-for-you.js` (`export default
   async function init(el)`) and `forge-tools-that-work-for-you.css`. Register in
   `C2_BLOCKS` at `libs/utils/utils.js:111`. Emit the L22 test fixture
   (`mocks/body.html` + `forge-tools-that-work-for-you.test.js`) so forge-block-lint passes.
...
- R3 matcher decision: `loose-variant` (score: 0.71)
