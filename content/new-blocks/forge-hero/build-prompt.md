...
- **Target path:** `/Users/victor/dev/da-playground/.forge-worktrees/session-5dae1546/libs/c2/blocks/forge-hero` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/da-playground/.forge-worktrees/session-5dae1546/libs/c2/blocks/forge-hero/forge-hero.js` (`export default
