...
// (`block > div > div > <content>`). The scoped CSS in forge-adobe-express-works-for-teams-enterprise-and-students.css
...
export default function decorate(block) {
  ...
  block.dataset.bespoke = 'forge-adobe-express-works-for-teams-enterprise-and-students';
}
