...
// (`block > div > div > <content>`). The scoped CSS in features-cards.css
// targets the natural HTML structure (`.features-cards .nucleus`, etc.) so we
// lift the content out of EDS's wrappers before the styles apply.
export default function decorate(block) {
  ...
  block.dataset.bespoke = 'features-cards';
}
